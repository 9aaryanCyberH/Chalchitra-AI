...
<style>
    .main {
        ...
        color: #ffffff; /* Keep main content readable on dark gradient */
        position: relative;
        overflow-x: hidden;
    }
    ...
    /* Ensure only main content uses white text, not the sidebar */
    .main .stMarkdown, .main .stText, .main .stTitle, .main .stHeader {
